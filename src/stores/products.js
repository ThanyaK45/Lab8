  ...
  state: () => ({
    ...
    productsList : [
      { id : 1,
        ...
        Price : '฿273.00',
        PriceCal : 273.00, 
        img : "public/img/Adidas.jpg"},
      { id : 2,
        Name : 'FARUILINE STORE กางเกงคาร์โก้ลําลอง',
        Price : '฿363.00',
        PriceCal : 363.00, 
        img : 'public/img/Cargo.png'},
      { id : 3,
        Name : 'Converse Run Star Hike Lugged',
        Price : '฿3,600.00',
        PriceCal : 3600.00, 
        img : 'public\img\Converse.png'},
      { id : 4,
        Name : 'หมวกเบสแฟชั่น ปักลายดาว',
        Price : '฿120.00', 
        PriceCal : 120.00,
        img : 'public\img\Caps.jpg'},
      { id : 5,
        Name : 'Feiyana Backpack',
        Price : '฿350.00',
        PriceCal : 350.00, 
        img : 'public\img\Backpacks.jpg'},
      { id : 6,
        Name : 'Apple AirPods 3',
        Price : '฿5,890.00',
        PriceCal : 5890.00, 
        img : 'public\img\Airpods.jpg'},
      { id : 7,
      ...
      { id : 8,
        ...
        Price : '฿1,000.00', 
        PriceCal : 1000.00,
        img : 'public\img\Adidasbag.jpg'},
      { id : 9,
        Name : 'Oversized parka',
        Price : '฿2,699.00', 
        PriceCal : 2699.00, 
        img : 'public\img\hmcoat.jpg'},
      { id : 10,
        Name : 'Regular Fit Corduroy shirt',
        Price : '฿799.00',
        PriceCal : 799.00, 
        img : 'public\img\hmshirt.jpg'},
        ],
        CartList : [],
        OrderList : [],
        totalOverallPrice: 0
